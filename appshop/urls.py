...
from appshop.views import ContactViewSet, ProductViewSet, NetworkLinkViewSet
...
network_link_router.register(r"chain_links", NetworkLinkViewSet, basename="network_link")
